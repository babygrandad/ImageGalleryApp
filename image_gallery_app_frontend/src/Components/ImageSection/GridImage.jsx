...
function GridImage({ imageID, imageName, imageURL, category, tags, likesCount, commentCount, handleLikes }) {
        ...
        >
            ...
            <div className={ImageSectionStyle.socialWrapper}>
                <div className={ImageSectionStyle.socialButtoncontainer}>
                    <span className={`${ImageSectionStyle.socialButton} material-symbols-outlined`} onClick={() => handleLikes(imageID)}>favorite</span>
